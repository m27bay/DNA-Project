...
/*####################################################################*/
	...
	//~ ALIGNEMENT *A=AligneAllFam(F, nbrFam);
	//~ AffAlignAll(A, nbrFam);
	//~ AffAlignDessinAll(A, nbrFam);
	
	ALIGNEMENT *A2=AligneAllFam(F2, nbrFam2);
	AffAlignAll(A2, nbrFam2);
	AffAlignDessinAll(A2, nbrFam2);
